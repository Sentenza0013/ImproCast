...
function setOverlayContent(type) {
    ...
    setText("overlayTitle", titleMap[type] || "ImproCast Arena");
    setText("overlayText", textMap[type] || eventName);
}
...
function showOverlay(type) {
    ...
    if (type === "category" || type === "theme" || type === "intro") {
...
function mettreAJourAffichage() {
    ...
    setText("penaliteRougeAff", `Fautes : ${current.penaliteRouge}`);
    setText("penaliteBleuAff", `Fautes : ${current.penaliteBleu}`);
